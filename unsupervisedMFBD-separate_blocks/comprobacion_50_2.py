...
if __name__ == "__main__":
    import traceback
    try:
        model_ckpt = "/scratch/paulabp/TFM/run_outputs_v6_50_acc_sched_instance_norm_2/best_model.pt"
        data_dir = "/scratch/paulabp/TFM/images/images_for_network/originals_cropped"
        output_dir = "/scratch/paulabp/TFM/run_outputs_comprobacion_50_2/plots"
