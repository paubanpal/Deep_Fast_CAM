...
def evaluate_reconstruction_and_modes(model_path, data_path, orig_data_path, save_dir, device='cuda'):
    ...
    if matched_orig_path and matched_orig_path.exists():
        ...
        # Normalizar el stack completo de la Imagen Real Original por su valor píxel máximo
        raw_orig_stack = raw_orig_stack / (raw_orig_stack.max() + 1e-8)
...
if __name__ == "__main__":
    import traceback
    try:
        model_ckpt = "/scratch/paulabp/TFM/run_outputs_v6_50_acc_sched_instance_norm_2channels_imageFFT_fixed_v6/best_model.pt"
        ...
        output_dir = "/scratch/paulabp/TFM/run_outputs_v6_50_acc_sched_instance_norm_2channels_imageFFT_fixed_v6/run_outputs_comprobacion_50/plots"
