...
def evaluate_reconstruction_and_modes(model_path, data_path, orig_data_path, save_dir, device='cuda'):
    ...
    for test_idx, test_sample_info in enumerate(dataset.test_samples):
        ...
        images_1ch = test_sample["images"].unsqueeze(0).to(device)     # [1, 50, 1, H, W]
...
if __name__ == "__main__":
    ...
    try:
        ...
        output_dir = "/scratch/paulabp/TFM/run_outputs_v6_50_acc_sched_instance_norm_1channel_multipFFT_phaseonly_fixed_v4_test/run_outputs_comprobacion_50/plots"
