...
def save_array_as_png(array_data, output_path, cmap_name='viridis'):
    """
    Saves a 2D array as a PNG image with a colour scale legend (colorbar).
    """
    ...
    # Render figure with colorbar using Matplotlib
...
def process_tiff_stack_fft(input_path, output_folder, apodize=True):
    ...
    if is_3d:
        ...
        save_array_as_png(magnitude_stack[0], output_folder / f"{stem}{suffix}_FFT_col_scale_magnitude_slice0.png", cmap_name='viridis')
        save_array_as_png(real_stack[0], output_folder / f"{stem}{suffix}_FFT_col_scale_real_slice0.png", cmap_name='bwr')
        save_array_as_png(imag_stack[0], output_folder / f"{stem}{suffix}_FFT_col_scale_imaginary_slice0.png", cmap_name='bwr')
        save_array_as_png(phase_stack[0], output_folder / f"{stem}{suffix}_FFT_col_scale_phase_slice0.png", cmap_name='twilight')
    else:
        # Standard 2D file save
        save_array_as_png(magnitude_stack, output_folder / f"{stem}{suffix}_FFT_col_scale_magnitude.png", cmap_name='viridis')
        save_array_as_png(real_stack, output_folder / f"{stem}{suffix}_FFT_col_scale_real.png", cmap_name='bwr')
        save_array_as_png(imag_stack, output_folder / f"{stem}{suffix}_FFT_col_scale_imaginary.png", cmap_name='bwr')
        save_array_as_png(phase_stack, output_folder / f"{stem}{suffix}_FFT_col_scale_phase.png", cmap_name='twilight')
...
output_base_path = Path(r"I:\Departamentos\Óptica\paulabp\master\TFM\MFBD images\FFT\new methods (crops power of 2)")

image_mapping = {
    ("CS", "binarias"): [
        "CHR181_cropped_shifted_128.tif", "wds15245_I_20230510_2000_3s_100p_selected_500_cropped_shifted_512.tif",
        "CHR181_cropped_shifted_128_col_scale_average.tif", "wds15245_I_20230510_2000_3s_100p_selected_500_cropped_shifted_512_average.tif"
    ],
    ("CS", "dudosas-binarias"): [
        "LAB4_cropped_shifted_128.tif", "STF1967_cropped_shifted_128.tif", "YSC8AB_cropped_shifted_128.tif", 
        "hu874_I_20240228_max_3s_100p_selected_500_cropped_shifted_256.tif", "LAB4_cropped_shifted_128_average.tif", 
        "STF1967_cropped_shifted_128_average.tif", "YSC8AB_cropped_shifted_128_average.tif", 
        "hu874_I_20240228_max_3s_100p_selected_500_cropped_shifted_256_average.tif"
    ],
    ("CS", "simples"): [
        "COU1897_f3_I_20240317_max_3s_100p_selected_600_cropped_shifted_128.tif", "FK384_cropped_shifted_128.tif", 
        "COU1897_f3_I_20240317_max_3s_100p_selected_600_cropped_shifted_128_average.tif", "FK384_cropped_shifted_128_average.tif"
    ],
    ("NOT", "binarias"): [
        "55Uma_NOT_cropped_shifted_128.tif", "CHR181_NOT_cropped_shifted_128.tif", "wds16289_NOT_cropped_shifted_512.tif", 
        "55Uma_NOT_cropped_shifted_128_average.tif", "CHR181_NOT_cropped_shifted_128_average.tif", "wds16289_NOT_cropped_shifted_512_average.tif"
    ],
    ("NOT", "dudosas-binarias"): [
        "wds14514_NOT_cropped_shifted_128.tif", "wds14514_NOT_cropped_shifted_128_average.tif"
    ],
    ("NOT", "simples"): [
        "COU1987_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128.tif", 
        "KUI48_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128.tif", 
        "COU1987_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128_average.tif", 
        "KUI48_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128_average.tif"
    ]
}
