...
def read_and_deconvolve(path_image, path_folder):
    ...
    for i in n_images:
        ...
        config_path = script_dir / 'config_CS_yaml_1_119.yaml'
        decSI = torchmfbd.Deconvolution(str(config_path))

        # Create patches using size 128
        frames_patches = PyTorchPatchify.patchify(frames[:, :, :], patch_size=512, stride_size=250)
        ...
        obj = []
        frames_back = []
        orig_shape = frames[:, :, :].shape  # [10, 300, 300]
        ...
        # Check if the output is a raw 2D image (300, 300) and expand for uniform plotting loops
        ...
        # ========================================================
        # NEW ADDITION: Save the actual 300x300 restored image!
        # ========================================================
        # obj[0] contains the numpy array of shape (1, 300, 300)
        # We slice obj[0][0] to get the clean 2D image matrix (300x300)
...
star_type = ["binarias"]
images_binarias = ["wds15245_I_20230510_2000_3s_100p_selected_500_cropped_shifted_512.tif"]
