...
def read_and_deconvolve(path_image, path_folder):
    ...
    for i in n_images:
        ...
        config_path = script_dir / 'config_NOT_yaml_1_119.yaml'
...
#hpc_base_path = Path("/scratch/paulabp/TFM/images/44_KL_modes/NOT/")
#hpc_base_path = Path("/scratch/paulabp/TFM/images/77_KL_modes/NOT/")
hpc_base_path = Path("/scratch/paulabp/TFM/images/119_KL_modes/NOT/")
star_type = ["binarias"]
images_binarias = ["wds16289_NOT_cropped_shifted_512.tif"]
