...
class Network(nn.Module):
    def __init__(self, device='cpu', n_modes=44, n_frames=5, pixel_size=0.042, \
        telescope_diameter=150.0, central_obscuration=0.0, wavelength=8000.0, basis_for_wavefront='kl', npix_image=128):
        ...
        self.modalnet = CNN(n=16, n_lstm=256).to(self.device)
        self.modalnet = LSTM(n_modes=self.n_modes, n_lstm=256).to(self.device)
