...
def read_and_deconvolve(path_image, path_folder):
    ...
    for i in n_images:
        ...
        config_path = script_dir / 'config_NOT_yaml_119.yaml'
...
#images_binarias = ["55Uma_NOT_cropped_shifted.tif"]
images_binarias = ["55Uma_NOT_cropped_shifted_128.tif", "CHR181_NOT_cropped_shifted_128.tif"]
images_dud_binarias = ["wds14514_NOT_cropped_shifted_128.tif"]
images_simples = ["COU1987_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128.tif", "KUI48_I_20240124_NOT_max_3s_100p_selected_500_cropped_shifted_128.tif"]
