...
def read_and_deconvolve(path_image, path_folder):
    ...
    for i in n_images:
        ...
        config_path = script_dir / 'config_CS_yaml_119.yaml'
...
images_binarias = ["CHR181_cropped_shifted_128.tif"]
images_dud_binarias = ["LAB4_cropped_shifted_128.tif", "STF1967_cropped_shifted_128.tif", "YSC8AB_cropped_shifted_128.tif"]
images_simples = ["COU1897_f3_I_20240317_max_3s_100p_selected_600_cropped_shifted_128.tif", "FK384_cropped_shifted_128.tif"]
